...
interface MainRegisterProps {
  ...
  onOpenRegisterStage2: () => void;
  onOpenMainLogin: () => void;
}

export const MainRegister: FC<MainRegisterProps> = ({
  onOpenRegisterStage2,
  onOpenMainLogin,
}) => {
  return (
    <>
      <Typography className={styles.title}>Регистрация</Typography>
      <Box style={{ width: 328, height: 240 }}>
        <Box className={styles.content}>
          <Button onClick={onOpenRegisterStage2} fullWidth variant="contained" color="inherit">
          ...
          <Button fullWidth className="mt-15" variant="contained" color="inherit">
        ...
        <Box className={styles.miniButton}>
          <Button variant="contained" color="inherit" className={styles.socialButton}>
      ...
      <Box className="d-flex flex-column mt-10">
        <Typography>
          Есть аккаунт?{' '}
          <a style={{ color: '#3766a9', cursor: 'pointer' }} onClick={onOpenMainLogin}>
            Войти
          </a>
        </Typography>
      </Box>
      <Box style={{ marginTop: 'auto', minHeight: 22 }}>
