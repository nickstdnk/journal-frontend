...
export const MainLogin: FC<MainLoginProps> = ({ onOpenLoginStage2, onOpenMainRegister }) => {
  return (
    <>
      <Typography className={styles.title}>Вход в аккаунт</Typography>
      <Box style={{ width: 328, height: 240 }}>
        <Box className={styles.content}>
          <Button onClick={onOpenLoginStage2} fullWidth variant="contained" color="inherit">
